...
<template>
    ...
    >
        ...
        <Button btn-class-name="p-2 bg-gray-300 max-w-fit h-fit m-2 rounded-xl border-none" :disabled="showList.size === 0" @click="clear" iconClassName="ml-2 w-5 h-5" icon="trash">clear</Button>
    </div>
    <div
